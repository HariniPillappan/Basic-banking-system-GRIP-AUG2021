        ...
        <div class="carousel-item active first-slider">
          <div class="inside-container">
            <div class="row">
              <div class="col-lg-8">
                <div class="our-text">
                  <h2><b style="color:white;">Intern Bank of transfer</b></h2>
                  <p style="color:white;">Welcome to online banking!!!</p>
                  <div class="butns"><br><br><br><br>
                    <a href="viewusers.php" class="about-btn" role="button">Send Money</a>
