...
<body>
    ...
    <div class="container divStyle"><br><br>
        ...
        <form method="post" name="tamount" class="tabletext"><br />
            <label> From: </label><br />
            <div>
                <table class="table roundedCorners  tabletext table-hover table-light  table-striped table-condensed">
                    <tr>
                        <th>Id</th>
                        <th>Name</th>
                        <th>Email</th>
            ...
            <br /><br /><br />
            <label>To:</label>
            <select class=" form-control" name="to" style="margin-bottom:1%; " required>
